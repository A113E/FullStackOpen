 ...
 const addBlog = (event) => {
  ...
  return ( 
    ...
    <form onSubmit={addBlog}>
      <div>
        Title: <input  value={newTitle} onChange={event => setNewTitle(event.target.value)} id='title-input' data-testid='title' />
      </div>
      <div>
        Author: <input  value ={newAuthor} onChange={event => setNewAuthor(event.target.value)} id='author-input' data-testid='author' />
      </div>
      <div>
        URL: <input value = {newUrl} onChange={event => setNewUrl(event.target.value)} id='url-input' data-testid='url' />
      </div>
